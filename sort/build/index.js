...
const characterCollection = new CharactersCollection_1.CharacterCollection('BAsermsdbsui');
console.log(`Character collection  data before sorting : ${characterCollection.data}`);
console.log('Sorting...');
characterCollection.sort();
console.log(`Character collection  data after sorting : ${characterCollection.data}`);
